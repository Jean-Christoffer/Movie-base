    ...
    return(
        <>
            <Paper  sx={{ bgcolor:'#f5f5f5',color:'black', display:'flex', width:'100%',p:1, alignItems:'center', mb:1}}>
                <Box sx={{ width:'90px' }}>
                    {loading ? loaderSpinner : <img alt={details.original_title ?? details.name} src={details.poster_path ? `https://image.tmdb.org/t/p/w500/${details.poster_path}` : '/2922280_27002.jpg'} className='toprated'/>}
                </Box>
